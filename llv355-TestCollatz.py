...
from Collatz import collatz_read, collatz_eval, collatz_print, collatz_solve, cache_eval
...
class TestCollatz(TestCase):
    ...
    def test_c_eval_1(self):
        v = cache_eval(1)
        self.assertEqual(v, 1)

    def test_c_eval_2(self):
        v = cache_eval(100)
        self.assertEqual(v, 26)

    def test_c_eval_3(self):
        v = cache_eval(200)
        self.assertEqual(v, 27)
    def test_c_eval_4(self):
        v = cache_eval(100000)
        self.assertEqual(v, 129)
    def test_c_eval_5(self):
        v = cache_eval(50000)
